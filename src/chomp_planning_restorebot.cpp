...
//ISSUE: How do I include this hybrid plugin loader?
//the following line is the one that is listed from the package information
...
int main(int argc, char** argv) {
 ...
 // BEGIN_TUTORIAL
  ...
  start_pose2_tar.position.x = 0.55;
  start_pose2_tar.position.y = -0.05;
  start_pose2_tar.position.z = 0.8;
